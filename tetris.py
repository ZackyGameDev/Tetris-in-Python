...
pygame.draw.rect(tile_sprite, (255, 255, 255), pygame.Rect(0, 0, TILE_SIZE, TILE_SIZE))
###########################################################################################
...
while running:
	...
	for row in tilemap:
		x = 0
		for tile in row:
			if tile != 0: win.blit(tile_sprite, (x*TILE_SIZE, y*TILE_SIZE))
			else: pygame.draw.rect(win, (20, 20, 20), pygame.Rect(x*TILE_SIZE, y*TILE_SIZE, TILE_SIZE, TILE_SIZE))
			x += 1
		y += 1
